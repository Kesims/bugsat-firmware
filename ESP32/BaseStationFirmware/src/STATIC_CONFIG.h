...
#define LORA_SPREADING_FACTOR 8  //Spreading factor 1 - 12, higher value => lower speeds and higher link budget
// recommended 9-10
#define LORA_FREQUENCY 4341E5 // Frequency in Hz
...
#define API_ADDRESS "http://api.bugsat.cz/"

#define WIFI_SSID "phk"
#define WIFI_PASSWORD "heslophk"
#define ACCESS_TOKEN "bugsat"
