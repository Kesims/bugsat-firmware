...
#ifndef LIB_BMP390_HAL_BMP390_H_
#define LIB_BMP390_HAL_BMP390_H_
...
#define BMP390_SOFTRESET			0xB6

// Over sampling macros
#define BMP390_NO_OVERSAMPLING		0b00000000
#define BMP390_OVERSAMPLING_2X      0b00000001
#define BMP390_OVERSAMPLING_4X      0b00000010
#define BMP390_OVERSAMPLING_8X      0b00000011
#define BMP390_OVERSAMPLING_16X     0b00000100
#define BMP390_OVERSAMPLING_32X     0b00000101
...
#define BMP390_CALIBDATA_LEN	21

// FIFO
#define BMP390_NORMAL_PRESS_AND_TEMP_FRAME_HEADER    0x94U
#define BMP390_SENSOR_TIME_FRAME_HEADER              0xA0U
#define BMP390_EMPTY_FRAME_HEADER                    0x80U

/* ----- REGISTER MACROS ----- */

#define BMP390_PWR_CTRL_PRESS_ON	1U
#define BMP390_PWR_CTRL_PRESS_OFF	0U
#define BMP390_PWR_CTRL_TEMP_ON		(1U << 1)
#define BMP390_PWR_CTRL_TEMP_OFF	0U8
#define BMP390_PWR_CTRL_MODE_SLEEP	0U8
#define BMP390_PWR_CTRL_MODE_FORCED	(1U << 4)
#define BMP390_PWR_CTRL_MODE_NORMAL	(0b11U << 4)

#define BMP390_FIFO_CONFIG_1_FIFO_MODE_ON            1U
#define BMP390_FIFO_CONFIG_1_FIFO_MODE_OFF           0U
#define BMP390_FIFO_CONFIG_1_FIFO_STOP_ON_FULL_ON    (1U << 1)
#define BMP390_FIFO_CONFIG_1_FIFO_STOP_ON_FULL_OFF   0U
#define BMP390_FIFO_CONFIG_1_FIFO_TIME_EN_ON         (1U << 2)
#define BMP390_FIFO_CONFIG_1_FIFO_TIME_EN_OFF        0U8
#define BMP390_FIFO_CONFIG_1_FIFO_PRESS_EN_ON        (1U << 3)
#define BMP390_FIFO_CONFIG_1_FIFO_PRESS_EN_OFF       0U
#define BMP390_FIFO_CONFIG_1_FIFO_TEMP_EN_ON         (1U << 4)
#define BMP390_FIFO_CONFIG_1_FIFO_TEMP_EN_OFF        0U
...
#endif /* LIB_BMP390_HAL_BMP390_H_ */
